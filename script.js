...
const STORE = 
    [
      ...
      { question: 'Which sauce is NOT served in Chinese restaurants',
        answers: ['Sweet & Sour Sauce', 'Mustard', 'Ranch', 'Soy Sauce'],
        correctAnswer: 'Ranch'}, 
      ...
      { question: 'Which one of these messages is unlucky to be in a fortune cookie?',
...
function getQuizHtml(){
  let str= `
  <legend class="container" id="screen-question">
  ...
  let str = `
    <div class="feedback">
      <h3><img class="Icon" src="https://i.ytimg.com/vi/AVMtt2o2KiI/hqdefault.jpg" alt="stitch crying">
        Oh my God, you are donut...<br><span class="answerFeedback">The right answer is ${STORE[questionNum].correctAnswer}!!!</span></h3>
      <button type="button" id="js-btn-continue">Next</button>
    </div>`
  return str;
}
